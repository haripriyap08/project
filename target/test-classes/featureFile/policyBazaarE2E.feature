Feature: Policy bazaar
  @test
  Scenario Outline: storing the details of travel insurance plan details in policy bazaar
  ...
  @test
  Scenario Outline: validating the details of car insurance and capturing email address error 
    ...
    And User enters valid details and click on next
    ...
    Examples: 
      ...
      | TN-23-6543 | KIA       | Sonet     | Diesel   | GTX Plus 1.5 AT (1493 cc) 					| 2023				  | abcd		 | abc					 | 9876023652 |

	@test
  Scenario Outline: Storing the insurance products menu and health insurance plan details
