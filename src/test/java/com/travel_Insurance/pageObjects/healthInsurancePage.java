...
public class healthInsurancePage extends basePage{
	...
	public void insProddpdn()
	{
		...
		act.moveToElement(insprodbutton).perform();
	...
	public void medicalHist()
	{
		...
		WebElement ofins=driver.findElement(By.xpath("//label[@for=\"ped_no\"]/div"));  //input[@name=\"ped_cat\"][@data-title=\"No\"]
		js.executeScript("arguments[0].click();", ofins);
		WebElement viewplanhealth=driver.findElement(By.xpath("//button[@id=\"btnHealthStep6\"]"));
		js.executeScript("arguments[0].click();", viewplanhealth);
	}
