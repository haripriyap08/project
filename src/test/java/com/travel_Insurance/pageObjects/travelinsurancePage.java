...
public class travelinsurancePage extends basePage {
	...
	By alldatescal = By.xpath("//span[@class='MuiPickersDay-dayLabel']"); 
	By noofAges = By.xpath("//div[@class='memSelectRadioWrapper']/div[2]");
	By ageSelectBox = By.xpath("//div[@id=" + j + "]");
	By dpdnAge = By.xpath("//div[@class='options_box_wrapper__option']");
   ...
   // for dates selection in calender
	...
	//error message for contact details mobile number
	public String error() {
