...
public class carInsuranceStepDefination {
	...
	public void user_captures_error_message_if_email_is_invalid() {
		...
		helperClass.Screenshot("emailaddressError");
	...
	@Then("User enters valid details and click on next")
	public void user_enters_valid_details_and_click_on_next() {
	...
	public void user_verifies_title_of_policy_bazaar_again_after_redirection() throws Exception {
